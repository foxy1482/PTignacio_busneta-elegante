...
const abrirCerrarFormulario = ()=>
{
    ...
    const aparecer = (elem)=>
    {
        elem.addEventListener("click",()=> { ocultarNav(); contactoWrapper.classList.remove("muyoculto"); contactoWrapper.classList.remove("oculto"); contactoContainer.classList.remove("oculto"); })
    }
